...
bool gIOC=false;
bool gTradeMessageSkip=false;
bool gReducedLogging=true;
bool  gCancelKludge=false; //  cancelled orders
int gParamNumber=0;
int gTimerDelayIOC=30;  // in millisecs
bool gFridayEOD=false;
...
bool gWorkerThread=false;
bool gDeleteCandles=true;
int gTimerMins=5;
int gLookbackDays=1;
int gWorkerTimer=0;